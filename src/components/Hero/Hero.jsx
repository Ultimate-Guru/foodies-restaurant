      ...
      <div className="container pb-8 sm:pb-0">
        <div className="grid grid-cols-1 sm:grid-cols-2">
          ...
          >
            ...
            <p className="text-sm ">
              Satisfy your cravings with our delicious and freshly prepared meals. Whether you are looking for a quick bite or a gourmet experience, we have got you covered!
            </p>
            <div>
